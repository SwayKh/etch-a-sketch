...
function renderGrid(noOfItems) {
    for (let i = 1; i <= noOfItems ** 2; i++) {
        ...
        pixelDiv.style.minWidth = String(grid.style.minWidth).replace("px", '') / noOfItems + "px"
        pixelDiv.style.minHeight = String(grid.style.minHeight).replace("px", '') / noOfItems + "px"
